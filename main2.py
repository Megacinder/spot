...
def set_args() -> Namespace:
    ...
    parser.add_argument('--start_date', type=str, default=datetime(2022, 9, 19).strftime("%Y%m%d"))
    parser.add_argument('--end_date', type=str, default=datetime(2022, 9, 20).strftime("%Y%m%d"))
